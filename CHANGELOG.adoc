...
:author: {author-name}
:!email: {author-email}
:revnumber: Branch feat/add-attributes-of-author v1.1.0 (Base v1.9.0)
:revdate: 2020-01-24T19:37:51+0900
:revremark: Add log that add attribute that twitter id of author \
